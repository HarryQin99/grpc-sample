...
const (
	PingPongService_PingPong_FullMethodName = "/org.example.pingpong.PingPongService/pingPong"
)
...
func (c *pingPongServiceClient) PingPong(ctx context.Context, in *PingPongRequest, opts ...grpc.CallOption) (*PingPongResponse, error) {
	...
	err := c.cc.Invoke(ctx, PingPongService_PingPong_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PingPongService_PingPong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PingPongService_PingPong_FullMethodName,
	}
...
var PingPongService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "org.example.pingpong.PingPongService",
